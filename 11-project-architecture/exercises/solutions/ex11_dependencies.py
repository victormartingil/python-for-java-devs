"""Provided wiring — identical in exercises/ and solutions/ (not an exercise).

The composition root: a module-level in-memory repository behind a dependency,
so tests can swap it via app.dependency_overrides. get_current_user is a
STAND-IN for the real JWT dependency (modules 09/11).
"""
